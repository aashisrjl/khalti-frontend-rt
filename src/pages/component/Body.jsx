...
const Body = () => {
  return (
    <div className="body bg-[url('/bg.jpg')] bg-cover bg-center h-screen flex flex-col items-center text-center backdrop-blur-md">
      ...
      <button className="mt-4 bg-yellow-500 text-white px-6 py-2 rounded-2xl hover:bg-blue-600">Sign Up</button>
    </div>
  );
};
